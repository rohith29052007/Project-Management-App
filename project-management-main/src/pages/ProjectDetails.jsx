...
export default function ProjectDetail() {
    ...
    // Refresh project data when task dialog closes (task was created)
    useEffect(() => {
        if (!showCreateTask && currentWorkspace?.id && id) {
            // Refresh workspace to get updated project with new tasks
            dispatch(fetchWorkspaceById(currentWorkspace.id));
        }
    }, [showCreateTask, dispatch, currentWorkspace?.id, id]);
